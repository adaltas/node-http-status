...
export interface HttpStatusExtra {
...
export interface HttpStatusUnofficial {
  readonly 103: string;
...
export interface HttpStatusIis {
  readonly 440: string;
...
export interface HttpStatusNginx {
  readonly 444: string;
...
export interface HttpStatusCloudfare {
  readonly 520: string;
